    ...
    def shoot(self):
        ...
        if now - self.last_shot > self.shoot_delay:
            ...
            if self.power == 4:
                ...
                bullet3 = Bullet2(self.rect.centerx, self.rect.top + 5)
                bullet4 = Bullet3(self.rect.centerx, self.rect.bottom - 5)
                bullet5 = Bullet4(self.rect.x+5,self.rect.y-50)
                all_sprites.add(bullet1)
                all_sprites.add(bullet2)
                all_sprites.add(bullet3)
                all_sprites.add(bullet4)
            ...
            if self.power == 5:
                ...
                bullet3 = Bullet2(self.rect.centerx, self.rect.top + 5)
                bullet4 = Bullet3(self.rect.centerx, self.rect.bottom - 5)
                bullet5 = Bullet4(self.rect.x+10,self.rect.y-50)
                bullet6 = Bullet4(self.rect.x+10,self.rect.y+70)
                all_sprites.add(bullet1)
                all_sprites.add(bullet2)
                all_sprites.add(bullet3)
                all_sprites.add(bullet4)
...
#powership weapon
bulletpow_img = pygame.image.load('oie_96305O8UORhCI.png').convert()
...
powshoot_sound = pygame.mixer.Sound('Flash-laser-02.wav')
...
pygame.mixer.music.load('cyclo2.wav')
